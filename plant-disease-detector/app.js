...
const DISEASE_INFO = {
  'Healthy': {
    ...
    label:  'Healthy Plant',
    barClass: '',
    recommendation: `Your plant appears healthy! Continue regular watering, 
      fertilisation, and monitoring. Inspect leaves weekly for early signs of disease. 
      Ensure proper drainage and avoid overwatering to maintain plant health.`
  },
  'Leaf Spot': {
    icon:   '⚠️',
    theme:  'warning',
    label:  'Leaf Spot Detected',
    barClass: 'warning',
    recommendation: `Leaf spot disease detected. Remove and destroy affected leaves immediately 
      to prevent spread. Apply a copper-based or sulphur fungicide as directed. 
      Water plants at the base rather than from above, and improve air circulation 
      around crops. Avoid working with plants when they are wet.`
  },
  'Blight': {
    icon:   '🚨',
    theme:  'diseased',
