 ...
 * chatbot.js
 * ─────────────────────────────────────────────────────────
 * AI Chatbot for PlantScan AI
 * Uses Google Gemini API to answer plant disease questions.
 * ─────────────────────────────────────────────────────────
 */
...
async function sendChatMessage() {
  ...
  try {
    ...
    appendMessage('bot', '⚠️ Sorry, I could not connect. Please check your internet connection and try again.');
  }
}
...
// ── CALLED BY app.js AFTER DIAGNOSIS ───────────────────────
